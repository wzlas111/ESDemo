...
public class DownloadManager {
    ...
    public static final int STATE_UNKNOWN_2           = 0x90;
    public static final int STATE_UNSTARTED_2         = 0x90; //144
    public static final int STATE_DOWNLOADING_2       = 0x91;
    public static final int STATE_TRANSIENT_FAILURE_2 = 0x92;
    public static final int STATE_PERMANENT_FAILURE_2 = 0x97;
    ...
    boolean getAutoDownloadState(SharedPreferences prefs, boolean roaming) {
        ...
        if (autoDownload) {
            boolean alwaysAuto = prefs.getBoolean(
                    RETRIEVAL_DURING_ROAMING, false);
